...
const ConfigurationsButton = ({sessionInfo, dispatch}) => {
  ...
  const handleClickButton = () => {
    ...
    dispatch({
      ...
      newIsConfigurationsMenuOpen: !sessionInfo.isConfigurationsMenuOpen
    })

    setIsMenuClosing({value: !isMenuClosing.value})
  }
...
export default connect(state => ({sessionInfo: state.sessionInfo}))(ConfigurationsButton)
